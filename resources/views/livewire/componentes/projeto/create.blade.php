                    ...
                    <div class="">
                        <div class="mb-4">
                            ...
                            <input type="text"
                                ...
                                id="exampleFormControlInput1" placeholder="Nome do projeto" wire:model="titulo">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text"
                                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                id="exampleFormControlInput3" wire:model="observacoes">
                            @error('observacoes') <span class="text-red-500">{{ $message }}</span>@enderror
                        </div>
                    </div>
                </div>
